...
public class QueryMain {
    ...
    public static void main(String[] args) {
        ...
        configureBufferManager(sqlquery.getNumJoin(), sqlquery.isDistinct(), sqlquery.getOrderByList().size(), args, in);
     ...
     **/
    private static void configureBufferManager(int numJoin, boolean isDistinct, int orderbySize, String[] args, BufferedReader in) {
        if (numJoin != 0 || isDistinct || orderbySize != 0) {
            int numBuff = 1000;
            if (args.length < 4) {
